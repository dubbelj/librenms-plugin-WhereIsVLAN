...
$form .= "Enter VLAN ID to search for:<input class='form-control' type='text' size='50' name='vlan_to_search' value='$vlan_to_search'><br>\n";
...
if ($result) {
    ...
    foreach ($result as $device_id => $device_data) {
        ...
        $device_url = "/device/device=$device_id/"; // Link to device page in LibreNMS
        $table = "<table class='tg'><tr><th colspan='7' class='tg-9hbo'><a href='$device_url'>$sysName</a> ($hostname)</th></tr>";
